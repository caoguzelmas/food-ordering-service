package com.caoguzelmas.foodorderingservice.orderservice.dataaccess.order.mapper;

import com.caoguzelmas.foodorderingservice.domain.valueobject.*;
import com.caoguzelmas.foodorderingservice.orderservice.dataaccess.order.entity.OrderAddressEntity;
import com.caoguzelmas.foodorderingservice.orderservice.dataaccess.order.entity.OrderEntity;
import com.caoguzelmas.foodorderingservice.orderservice.dataaccess.order.entity.OrderItemEntity;
...
public class OrderDataAccessMapper {
    ...
    private DeliveryAddress addressEntityToDeliveryAddress(OrderAddressEntity address) {
        return new DeliveryAddress(address.getId(), address.getStreet(), address.getPostalCode(), address.getCity());
    }
    ...
    private OrderAddressEntity deliveryAddressToAddressEntity(DeliveryAddress deliveryAddress) {
