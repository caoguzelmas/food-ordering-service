package com.caoguzelmas.foodorderingservice.kafka.consumer.config;


import com.caoguzelmas.foodorderingservice.kafka.config.data.KafkaConfigData;
import com.caoguzelmas.foodorderingservice.kafka.config.data.KafkaConsumerConfigData;
